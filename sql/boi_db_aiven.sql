...
-- Disable the primary key requirement for the session if possible
...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 23, 2025 at 05:38 AM
...
DROP TABLE IF EXISTS `zcomments_22`;
...
(2, 1, 'Hi', 'Nipun Paul', NULL, '2025-12-23 03:57:16');

--
-- Table structure for table `zmessage_19`
--

DROP TABLE IF EXISTS `zmessage_19`;
...
DROP TABLE IF EXISTS `zmessage_35`;
