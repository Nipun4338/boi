...
if (isset($_POST["delete"]) && isset($_POST["slider_id"])) {
    $id = $_POST["slider_id"];
    $stmt = mysqli_prepare($connection, "DELETE FROM slider2 WHERE slider_id = ?");
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title font-weight-bold text-primary" id="exampleModalLabel">Add New Signup Slider</h5>
            ...
            <form action="scripts.php" enctype="multipart/form-data" method="POST">
                ...
                <div class="modal-footer border-top-0">
                    ...
                    <button type="submit" name="registerbtnslider2" class="btn btn-primary shadow-sm px-4">Save Image</button>
                </div>
            </form>
        </div>
    </div>
...
<div class="container-fluid">
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex justify-content-between align-items-center">
            <h6 class="m-0 font-weight-bold text-primary">Signup Page Sliders</h6>
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover text-center" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        <?php
                        $query = "SELECT * FROM slider2 ORDER BY slider_id DESC";
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        <div class="d-flex justify-content-center">
                                            <form action="slider2_edit.php" method="post" class="mr-2">
                                                <input type="hidden" name="edit_id_slider2" value="<?php echo $row["slider_id"]; ?>">
                                                <button type="submit" name="edit_btn_slider2" class="btn btn-sm btn-info shadow-sm" title="Edit">
                                                    <i class="fas fa-edit"></i>
                                                </button>
                                            </form>
                                            <form action="slider2.php" method="POST" onsubmit="return confirm('Are you sure you want to delete this slide?');">
