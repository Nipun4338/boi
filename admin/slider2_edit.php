...
<div class="container-fluid">
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex justify-content-between align-items-center">
            <h6 class="m-0 font-weight-bold text-primary">Edit Signup Slider Details</h6>
            <a href="slider2.php" class="btn btn-sm btn-secondary shadow-sm"><i class="fas fa-arrow-left"></i> Back to List</a>
        </div>

        <div class="card-body">
            <?php 
            if (isset($_POST["edit_btn_slider2"]) && isset($_POST["edit_id_slider2"])) {
                $id = $_POST["edit_id_slider2"];
                
                // Fetch slider details using prepared statement
                $stmt = mysqli_prepare($connection, "SELECT * FROM slider2 WHERE slider_id = ?");
                    ...
                    <form action="scripts.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                ...
                                <div class="mt-4">
                                    <button type="submit" name="updatebtnslider2" class="btn btn-primary px-5 shadow-sm">
                                        <i class="fas fa-save mr-2"></i> Update Slider Details
                                    </button>
                                    <a href="slider2.php" class="btn btn-outline-danger ml-2">Cancel</a>
                                </div>
                            </div>
                        </div>
                    </form>
