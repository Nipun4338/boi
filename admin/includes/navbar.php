   ...
   <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
       ...
       <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
           ...
           <img src="favicon.svg" style="padding:5px;">
           <div class="sidebar-brand-text mx-3">বই</div>
       </a>
       ...
       <li class="nav-item">
           ...
           <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
               ...
               <div class="bg-white py-2 collapse-inner rounded">
                   <h6 class="collapse-header">State:</h6>
                   <a class="collapse-item" href="bookinfo.php">Unpublished</a>
                   <a class="collapse-item" href="bookinfopub.php">Published</a>
               </div>
           </div>
       </li>
       <li class="nav-item">
