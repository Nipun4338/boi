                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="container-fluid">
                        <div id="carouselExample" class="carousel slide" data-ride="carousel" data-interval="4000">
                            <div class="carousel-inner row w-100 mx-auto" role="listbox">
                                ...
                                <div class="carousel-item active">
                                    ...
                                    <div class="col-lg-2 col-md-6">
                                        <img class="img-fluid" src="<?php echo $row1[
                                            "image"
                            ...
                            <a class="carousel-control-prev bg-dark w-auto" href="#carouselExample" role="button"
                                data-slide="prev">
                                <span class="carousel-control-prev-icon" aria-hidden="true"></span>

                            </a>
                            <a class="carousel-control-next bg-dark w-auto" href="#carouselExample" role="button"
                                data-slide="next">
                    ...
                    <div class="row">
                        <div class="center">
                            <div class="pagination" style="padding: 10px">
                                <?php if (
                                    $page >= 2
                                ) { ?><a href="home?page=<?php echo $page -
    1; ?>">&laquo;</a>
                                <?php } ?>
                                <?php
                                $c = 0;
                                for ($b = 1; $b <= $a; $b++) {
                                    if (
                                        $b == $page
                                    ) { ?><a class="active" href="home?page=<?php echo $b; ?>" style="text-decoration: none"><?php echo $b,
    " "; ?></a><?php } elseif (
                                        $page == "" &&
                                        $c == 0
                                    ) { ?><a class="active" href="home?page=<?php echo $b; ?>" style="text-decoration: none"><?php echo $b,
    " "; ?></a><?php $c = 1;} else { ?><a href="home?page=<?php echo $b; ?>" style="text-decoration: none"><?php echo $b,
    " "; ?></a><?php }
                                }
                                ?>
                                <?php if (
