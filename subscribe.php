...
if (isset($_REQUEST["submit"])) {
    ...
    if ($noOfRows) {
        ...
        if (empty($_POST["file"])) {
            $target_dir =
                "https://ucarecdn.com/4d13fbd1-4dbf-4fc3-8a56-3cbb8fba76e4/";
        } else {
            $target_dir = $_POST["file"];
        }
        $hash1 = md5(rand(0, 1000));
        $sqlInsert =
            'insert into user(name,email,phone,address,password,image,status,created_date,updated_date,hash)
				 values("' .
            $user_name .
            '","' .
            $user_email .
        ...
        $mail->Body =
          ...
          <p><a href="http://boi-yourbook.herokuapp.com/verify?email=' .
            $user_email .
            "&hash=" .
            $hash1 .
            '">Click to Verify</a></p>
        ...
        $success_message =
            ...
            $user_email .
            ", so before login first verify your email!";
    }
}
?>
            ...
            <div class="col-md-8" style="text-align:center">
                ...
                if ($noOfRows) {
                    while ($row = mysqli_fetch_assoc($query_run)) {
                        /*echo "<pre>";
                         print_r($row);*/ array_push($data, $row); //echo "</pre>";
                    }
                }
                shuffle($data);
                foreach ($data as $row) { ?>
                <img class="img-fluid" alt="Responsive image" style="margin-bottom:10px; " src="<?php echo $row[
                    "image"
                ]; ?>">
                <?php }
                ?>
                            ...
                            <form class="form-container" action="" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="email" name="email" value=""
                                        placeholder="Enter your email (must be unique)" class="form-control" required />
                                </div>
                                <div class="form-group mb-3">
                                    <label>Phone</label>
                                    <input type="Phone" name="phone" value="" placeholder="Enter your phone number"
                                        class="form-control" required />
                                </div>
                                <div class="form-group mb-3">
                                    <label>Address</label>
                                    <textarea type="message" name="address" placeholder="Type your address here"
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="password" id="confirm_password" name="confirm_password" value=""
                                        placeholder="Retype Password" class="form-control" required />
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="hidden" name="file" role="uploadcare-uploader" data-clearable="true"
                                        data-crop="free" />
                                </div>
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" id="exampleCheck1">
                                    <label class="form-check-label" for="exampleCheck1">By creating an account you agree
                                        <br>to our <a href="#" style="color:black">Terms & Policy</a></label>
                                </div>

                                <button type="submit" id="submit" name="submit" value="Submit"
                                    class="btn btn-primary btn-block submit2">Submit</button>
