   ...
   <div class="container">
     <div class="row">
       <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
         <img style="width: 100%;object-fit: cover;margin-bottom: 30px" class="card-img card-img-bottom img-fluid" src="images/Nipun_Paul.jpg" alt="Nipun Paul">
      </div>
      <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">

          <h4 style="text-align:center;font-weight:bold; margin-bottom:15px">Nipun Paul</h4>
     		 <div class="container">
					 <h6 style="">I am fond of reading books, that's why tried to create a project like this. Doing something big without enough backend is tough. So I couldn't manage
					 enough database space. Even the chating system would be great without the database query limit. But that's why anything free has it's own limit, isn't it?</h6>
					 <br>
					 <div class="container">
					...
					<a href="https://www.linkedin.com/in/nipunpaul4338/"><span><i class="web fab fa-linkedin-in fa-3x"></i></span></a>
					<a href="https://www.facebook.com/nipun.paul.33/"><span><i class="web fab fa-facebook fa-3x"></i></span></a>
					<a href="https://nipun4338.github.io/"><span><i class="web fab fa-edge-legacy fa-3x"></i></span></a>
