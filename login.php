                                ...
                                <form class="form-container" action="code.php" method="POST">
                                    <div class="form-group">
                                        ...
                                        <?php if (
                                            ...
                                            echo '<h6 class="bg-danger text-white"> ' .
                                                $_SESSION["status"] .
                                                " </h6>";
                                    ...
                                    <button type="submit" name="login"
                                        class="btn btn-primary btn-block submit">Submit</button>
                ...
                <div class="col-md-8" style="text-align:center">
                    ...
                    <div class="w3-content w3-section" style="">
                        ...
                        <div class="w3-animate-opacity">
                            <img style="" class="img-fluid mySlides" alt="Responsive image" src="<?php echo $row[
                                "image"
                            ]; ?>">
                        </div>
                        <?php } ?>
